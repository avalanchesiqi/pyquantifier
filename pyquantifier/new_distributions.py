...
class ContinuousUnivariateDistribution(UnivariateDistribution):
    ...
    def plot(self, **kwds):
        ...
        line_style = kwds.pop('line_style', '-')
        ...
        if edge:
            ax.plot(self.x_axis, top_axis, label=label, c=edge_color, lw=2, zorder=40, ls=line_style)
...
class MixtureCUD(ContinuousUnivariateDistribution):
    ...
    def __init__(self, components, weights):
        ...
        self.update_bin_axis(num_bin=500)
...
class JointDistribution:
    ...
    def plot_five_distributions(self, num_bin=500):
        ...
        self.classifier_score_distribution.plot(ax=axes[4], num_bin=num_bin)
        axes[4].set_title('Classifier Score Density')
        ...
        self.calibration_curve.plot(ax=axes[5])
        axes[5].set_title('Calibration Curve')
...
class IntrinsicJointDistribution(JointDistribution):
    ...
    def calculate_calibration_curve(self, num_bin=500):
